...
class IngredientesControllerTest < ActionController::TestCase
  ...
  test "should create ingrediente" do
    assert_difference('Ingrediente.count') do
      post :create, ingrediente: { nombre: @ingrediente.nombre, pizza1_id: @ingrediente.pizza1_id, valor: @ingrediente.valor }
    end
  ...
  test "should update ingrediente" do
    patch :update, id: @ingrediente, ingrediente: { nombre: @ingrediente.nombre, pizza1_id: @ingrediente.pizza1_id, valor: @ingrediente.valor }
    assert_redirected_to ingrediente_path(assigns(:ingrediente))
  end
